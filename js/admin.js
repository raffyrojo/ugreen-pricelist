...
function _admRailHtml(){
  return '<aside class="adm-rail">'+
    ...
    '<nav class="adm-rail-nav">'+
      ...
      _admRailItem('tab-dealers','Special Dealers',_ADM_ICONS.pricing,false)+
