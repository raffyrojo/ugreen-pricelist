...
function renderAdminContent(){
  ...
  if(_ac.check()){
    ...
    el.innerHTML=
      '<div class="adm-dash">'+'<aside class="adm-rail">'+'<div class="adm-rail-brand"><img class="adm-rail-logo" src="'+UGREEN_LOGO_DARK+'" alt="UGREEN"><span class="adm-rail-badge">Admin</span></div>'+'<nav class="adm-rail-nav">'+'<div class="adm-rail-group">Main</div>'+'<button class="adm-rail-item active" onclick="admTab(this,\x27tab-overview\x27)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/></svg>Dashboard</button>'+'<button class="adm-rail-item" onclick="admTab(this,\x27tab-sku\x27)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>SKU Management</button>'+'<button class="adm-rail-item" onclick="admTab(this,\x27tab-categories\x27)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>Categories</button>'+'<button class="adm-rail-item" onclick="admTab(this,\x27tab-io\x27)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>Import / Export</button>'+'<div class="adm-rail-group">Content</div>'+'<button class="adm-rail-item" onclick="admTab(this,\x27tab-promo\x27)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>Popup Ads</button>'+'<div class="adm-rail-group">System</div>'+'<button class="adm-rail-item" onclick="admTab(this,\x27tab-versions\x27)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>Version History</button>'+'<button class="adm-rail-item" onclick="admTab(this,\x27tab-settings\x27)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>Settings</button>'+'</nav>'+'<div class="adm-rail-foot"><div class="adm-rail-user"><span class="adm-rail-avatar">RR</span><div><div class="adm-rail-uname">Raffy Rojo</div><div class="adm-rail-urole">Admin \u00b7 '+APP_VERSION+'</div></div></div>'+'<button class="adm-rail-logout adm-rail-logoutbtn" onclick="adminLogout()"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>Logout</button></div>'+'</aside>'+'<div class="adm-main">'+'<header class="adm-main-top"><div><h2 class="adm-main-title" id="adm-tab-title">Dashboard</h2><p class="adm-main-sub">Overview of your UGREEN pricelist</p></div>'+'<div class="adm-main-actions"><button class="btn-secondary" style="font-size:.8rem" onclick="closeAdminModal();openPanel(\x27add\x27)">+ Add SKU</button>'+'<button class="adm-btn-cta" onclick="closeAdminModal();saveCurrentVersion()"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>Save ('+APP_VERSION+')</button>'+'<button class="adm-close-btn" onclick="closeAdminModal()" title="Close">&times;</button></div></header>'+'<div class="adm-main-scroll">'+'<div class="adm-tab active" id="tab-overview">'+'<div class="adm-kpi-row k5">'+'<div class="adm-kpi"><div class="adm-kpi-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg></div><div class="adm-kpi-val">'+ALL_PRODUCTS.length+'</div><div class="adm-kpi-label">Total Products</div></div>'+'<div class="adm-kpi"><div class="adm-kpi-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg></div><div class="adm-kpi-val">'+_admSectionCounts().length+'</div><div class="adm-kpi-label">Categories</div></div>'+'<div class="adm-kpi"><div class="adm-kpi-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg></div><div class="adm-kpi-val">'+DELETED_PRODUCTS.length+'</div><div class="adm-kpi-label">Hidden</div></div>'+'<div class="adm-kpi"><div class="adm-kpi-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></div><div class="adm-kpi-val">'+loadNewSkus().length+'</div><div class="adm-kpi-label">Pending Edits</div></div>'+'<div class="adm-kpi"><div class="adm-kpi-ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg></div><div class="adm-kpi-val" style="font-size:1.05rem">'+APP_VERSION+'</div><div class="adm-kpi-label">Version</div></div>'+'</div>'+'<div class="adm-ov-2col"><div class="adm-panel"><div class="adm-panel-head"><div class="adm-panel-title">Products by Section</div><div class="adm-panel-sub">Top sections by count</div></div><div class="adm-chart">'+renderSectionChartHtml()+'</div></div>'+'<div class="adm-panel"><div class="adm-panel-head"><div class="adm-panel-title">Price Distribution (SRP)</div><div class="adm-panel-sub">Products by SRP range</div></div><div class="adm-chart">'+renderPriceDistHtml()+'</div></div></div>'+'<div class="adm-card adm-card-full">'+
        '<div class="adm-card-header">'+
          '<span class="adm-card-icon activity" id="sec-activity"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></span>'+
          '<div><div class="adm-card-title">Recent Activity</div><div class="adm-card-sub">Latest changes and actions</div></div>'+
        '</div>'+
        '<div style="max-height:200px;overflow-y:auto">' + renderActivityHtml() + '</div>'+
      '</div>'+'</div>'+'<div class="adm-tab" id="tab-sku">'+'<div class="adm-sku-topbar"><div><div class="adm-sku-title">SKU Management</div><div class="adm-panel-sub" id="sku-count">'+ALL_PRODUCTS.length+' SKUs</div></div>'+'<div class="adm-sku-topbtns">'+'<button class="btn-secondary" onclick="closeAdminModal();document.getElementById(\x27excel-upload-input\x27).click()">Import Excel</button>'+'<button class="btn-secondary" onclick="closeAdminModal();downloadExcel(\x27recommended\x27)">Export</button>'+'<button class="adm-btn-cta" onclick="closeAdminModal();openPanel(\x27add\x27)">+ Add SKU</button>'+'<button class="btn-ghost" id="btn-rollback-upload-adm" onclick="closeAdminModal();rollbackUpload()" style="display:none">Undo Upload</button>'+'</div></div>'+'<div class="adm-sku-filters">'+'<input id="sku-search" class="adm-input" placeholder="Search name, model, code, material, UPC\u2026" oninput="skuFilter()">'+'<select id="sku-cat" class="adm-input" onchange="skuFilter()">'+renderSkuCatOptions()+'</select>'+'<select id="sku-price" class="adm-input" onchange="skuFilter()"><option value="">All prices</option><option value="a">\u20b10 \u2013 500</option><option value="b">\u20b1500 \u2013 2,000</option><option value="c">\u20b12,000 \u2013 5,000</option><option value="d">\u20b15,000+</option></select>'+'<select id="sku-sort" class="adm-input" onchange="skuFilter()"><option value="name">Product name</option><option value="code">Item code</option><option value="srp-asc">SRP: low to high</option><option value="srp-desc">SRP: high to low</option></select>'+'</div>'+'<div class="adm-panel" style="padding:0;overflow:hidden"><div class="adm-sku-tablewrap"><table class="adm-sku-table"><thead><tr><th>Image</th><th>Product</th><th>Item Code</th><th>Model</th><th class="adm-sku-thr">SRP / Dealer</th><th>Status</th><th class="adm-sku-thr">Actions</th></tr></thead><tbody id="sku-tbody"></tbody></table></div></div>'+'</div>'+'<div class="adm-tab" id="tab-categories">'+'<div class="adm-panel"><div class="adm-panel-head"><div class="adm-panel-title">Categories</div><div class="adm-panel-sub">'+_admSectionCounts().length+' sections \u00b7 auto-derived from products</div></div>'+renderCategoriesTableHtml()+'</div>'+'</div>'+'<div class="adm-tab" id="tab-io">'+'<div class="adm-panel"><div class="adm-panel-head"><div class="adm-panel-title">Import</div><div class="adm-panel-sub">Bring products in from Excel</div></div>'+'<button class="btn-secondary" style="width:100%" onclick="closeAdminModal();document.getElementById(\x27excel-upload-input\x27).click()">Upload Excel</button></div>'+'<div class="adm-panel"><div class="adm-panel-head"><div class="adm-panel-title">Export</div><div class="adm-panel-sub">Download the pricelist</div></div><div class="adm-io-grid">'+'<button class="btn-secondary" onclick="closeAdminModal();downloadPDF()">Price List (Quick)</button>'+'<button class="btn-secondary" onclick="closeAdminModal();openStyledPdf()">Price List (Detailed)</button>'+'<button class="btn-secondary" onclick="closeAdminModal();openCatalogPdf()">Product Catalog</button>'+'<button class="btn-secondary" onclick="closeAdminModal();downloadExcel(\x27original\x27)">Excel (Data)</button>'+'<button class="btn-secondary" onclick="closeAdminModal();downloadExcel(\x27recommended\x27)">Excel (Full)</button>'+'<button class="btn-secondary" onclick="closeAdminModal();saveAsNewVersion()">Save as New Version</button>'+'</div></div>'+'</div>'+'<div class="adm-tab" id="tab-promo">'+'<div class="adm-card adm-card-full">'+
        '<div class="adm-card-header">'+
  ...
  setTimeout(renderVersionHistory, 0);
}
