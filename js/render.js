...
function buildExpandRowHtml(p){
  return '<td colspan="9"><div class="expand-inner">'+
    ...
    '<div class="expand-right">'+
      ...
      '<div class="sku-action-bar" style="margin-top:.75rem;padding-top:.75rem;border-top:1px solid var(--border)"><button class="btn-screenshot" onclick="event.stopPropagation();captureSkuCard(\''+p.item_code+'\',this)"><svg class="ico-inline" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>Screenshot</button></div>'+
      (isAdmin()?'<div class="expand-admin-bar"><button class="btn-admin-edit" onclick="adminEditProduct(\''+p.item_code+'\')"><svg class="ico-inline" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>Edit SKU</button><button class="btn-admin-edit" onclick="adminDuplicateProduct(\''+p.item_code+'\')"><svg class="ico-inline" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>Duplicate</button><button class="btn-admin-del" onclick="adminDeleteProduct(\''+p.item_code+'\')"><svg class="ico-inline" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>Remove from List</button></div>':'')+
    '</div>'+
    '</div></td>';
}
...
function openModal(itemCode){
  ...
  var bottomParts=[];
  bottomParts.push('<div class="sku-action-bar" style="margin-bottom:.8rem;padding-bottom:.8rem;border-bottom:1px solid var(--border)"><button class="btn-screenshot" onclick="captureSkuCard(\''+p.item_code+'\',this)"><svg class="ico-inline" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>Screenshot</button></div>');
  ...
  if(isAdmin()){bottomParts.push('<div class="expand-admin-bar" style="margin-top:0.5rem"><button class="btn-admin-edit" onclick="adminEditProduct(\''+p.item_code+'\');closeModal()"><svg class="ico-inline" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>Edit SKU</button><button class="btn-admin-edit" onclick="adminDuplicateProduct(\''+p.item_code+'\');closeModal()"><svg class="ico-inline" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>Duplicate</button><button class="btn-admin-del" onclick="adminDeleteProduct(\''+p.item_code+'\');closeModal()"><svg class="ico-inline" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>Remove from List</button></div>');}
