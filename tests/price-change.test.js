...
chk('multi: badge 1,099 -> 1,049 Price Decrease, no 999', pcBadge(p,'SRP',true).includes('1,099') && pcBadge(p,'SRP',true).includes('1,049') && pcBadge(p,'SRP',true).includes('Price Decrease') && !pcBadge(p,'SRP',true).includes('999'));
